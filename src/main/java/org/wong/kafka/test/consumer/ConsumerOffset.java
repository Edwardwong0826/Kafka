...
public class ConsumerOffset {
    public static void main(String[] args) {
        ...
        // so kafka broker every 5 seconds consumer offset are auto committed, is done by consumer and auto commit is set to true
        ...
        // transaction isolation level, parameter value read_uncommitted, read_committed, default is read_uncommitted
        // does not care WRITE_TXN_MARKERS is success or not, consumer also will poll the data
